<template>
    <div id="app">
      ...
      <h3 style="text-align: center;margin-top: 1em"><u>Customer Invoice</u></h3>
      ...
      <div class="invoice">
        ...
        <div class="container">
          ...
          <div class="invoice-area" id="">
            <div id="printInvoice">
              ...
              <div class="col-5 right-area">
                ...
                <img class="text-center" :src="details.logo" style="height:10em;width: 10em">
                ...
                <table class="uk-table">
                  ...
                  <tbody>
                    <tr v-for="item in reversedArr" v-if="item.id">
                      ...
                      <td>{{item.warranty}} <span style="font-size: 13px;text-style:italic">(months)</span></td>
          ...
          <div id="printDetails" style="width: 300px;font-size: 12px!important;
            text-align: center;border:1px solid black;padding:20px 10px; page-break-inside: avoid;">
            <div class="com-logo text-center">
                <img :src="details.logo" style="height:10em;width: 10em">
            ...
            <table style="border:1px solid black;width: 100%;padding: 10px" >
              <tr style="width: 90%;text-align: left;">
                <td style="padding-left: 10px;" >Date :- <span id="curDate">{{currentDate}}</span></td>

              </tr>
              <tr style="width: 90%;text-align: left;" >
                <td style="padding-left: 10px;"  >Bil no :- <span>{{invoiceNo}}</span></td>

              </tr>
            </table>
            <hr>
            <table style="width: 100%;">
              <tr style="background-color: black;color: #ffffff;font-weight: bold;font-size: 12px;">
                <th>Name</th>
                <th>Qty</th>
                <th>Warranty</th>
                <th>Price</th>
              ...
              " >
                <td>{{item.itemName}}</td>
                <td>{{item.itemQty}}</td>
                <td>{{item.warranty}}&nbsp;<span style="font-size: 10px;" id="span1">Month/s</span></td>
            ...
            <div class="payments"  style="background-color: black;color: #ffffff;font-weight: bold;font-size: 12px">

              <table style="text-align: right;width: 90%;margin-right: 1em!important;" >
                <tr>
                  <th></th>
                  <th style="text-align: right;margin-right: 1em;" ></th>
                </tr>
            ...
            <div class="thank-you">
              <p style="text-align:center;font-size: 15px;font-weight: bold" >Thank you - Come back</p>
